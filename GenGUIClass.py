...
class ClassicTableEntryDialogGen ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		fgSizer7 = wx.FlexGridSizer( 9, 3, 0, 0 )
		fgSizer7.SetFlexibleDirection( wx.BOTH )
		fgSizer7.SetNonFlexibleGrowMode( wx.FLEX_GROWMODE_SPECIFIED )
		...
		fgSizer7.Add( self.m_staticText32, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.m_staticText33 = wx.StaticText( self, wx.ID_ANY, u"Display", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText33.Wrap( -1 )

		fgSizer7.Add( self.m_staticText33, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 5 )

		self.m_staticText34 = wx.StaticText( self, wx.ID_ANY, u"Sort", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText34.Wrap( -1 )

		fgSizer7.Add( self.m_staticText34, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 5 )

		self.m_staticText24 = wx.StaticText( self, wx.ID_ANY, u"Display Name:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText24.Wrap( -1 )

		fgSizer7.Add( self.m_staticText24, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tDisplayName = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tDisplayName, 0, wx.ALL, 5 )

		self.tDisplayNameSort = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer7.Add( self.tDisplayNameSort, 0, wx.ALL, 5 )

		self.m_staticText25 = wx.StaticText( self, wx.ID_ANY, u"URL:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText25.Wrap( -1 )

		fgSizer7.Add( self.m_staticText25, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tURL = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tURL, 0, wx.ALL, 5 )

		self.m_staticText37 = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText37.Wrap( -1 )

		fgSizer7.Add( self.m_staticText37, 0, wx.ALL, 5 )

		self.m_staticText26 = wx.StaticText( self, wx.ID_ANY, u"Other Names:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText26.Wrap( -1 )

		fgSizer7.Add( self.m_staticText26, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tOtherNames = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tOtherNames, 0, wx.ALL, 5 )

		self.m_staticText36 = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText36.Wrap( -1 )

		fgSizer7.Add( self.m_staticText36, 0, wx.ALL, 5 )

		self.m_staticText27 = wx.StaticText( self, wx.ID_ANY, u"Editors:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText27.Wrap( -1 )

		fgSizer7.Add( self.m_staticText27, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tEditors = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tEditors, 0, wx.ALL, 5 )

		self.tEditorsSort = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer7.Add( self.tEditorsSort, 0, wx.ALL, 5 )

		self.m_staticText28 = wx.StaticText( self, wx.ID_ANY, u"Dates:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText28.Wrap( -1 )

		fgSizer7.Add( self.m_staticText28, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tDates = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tDates, 0, wx.ALL, 5 )

		self.tDatesSort = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer7.Add( self.tDatesSort, 0, wx.ALL, 5 )

		self.m_staticText29 = wx.StaticText( self, wx.ID_ANY, u"Type", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText29.Wrap( -1 )

		fgSizer7.Add( self.m_staticText29, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tType = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tType, 0, wx.ALL, 5 )

		self.m_staticText35 = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText35.Wrap( -1 )

		fgSizer7.Add( self.m_staticText35, 0, wx.ALL, 5 )

		self.m_staticText30 = wx.StaticText( self, wx.ID_ANY, u"Issues:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText30.Wrap( -1 )

		fgSizer7.Add( self.m_staticText30, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tIssues = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tIssues, 0, wx.ALL, 5 )

		self.tIssuesSort = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer7.Add( self.tIssuesSort, 0, wx.ALL, 5 )

		self.m_staticText31 = wx.StaticText( self, wx.ID_ANY, u"Flags:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText31.Wrap( -1 )

		fgSizer7.Add( self.m_staticText31, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.tFlags = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
		fgSizer7.Add( self.tFlags, 0, wx.ALL, 5 )

		self.tFlagsSort = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer7.Add( self.tFlagsSort, 0, wx.ALL, 5 )


		bSizer6.Add( fgSizer7, 1, wx.EXPAND, 5 )
		...
		# Connect Events
		self.tDisplayName.Bind( wx.EVT_TEXT, self.OnTextDisplayName )
		self.tDisplayNameSort.Bind( wx.EVT_TEXT, self.OnTextDisplayNameSort )
		self.tURL.Bind( wx.EVT_TEXT, self.OnTextURL )
		self.tOtherNames.Bind( wx.EVT_TEXT, self.OnTextOtherNames )
		self.tEditors.Bind( wx.EVT_TEXT, self.OnTextEditors )
		self.tEditorsSort.Bind( wx.EVT_TEXT, self.OnTextEditorsSort )
		self.tDates.Bind( wx.EVT_TEXT, self.OnTextDates )
		self.tDatesSort.Bind( wx.EVT_TEXT, self.OnTextDatesSort )
		self.tType.Bind( wx.EVT_TEXT, self.OnTextType )
		self.tIssues.Bind( wx.EVT_TEXT, self.OnTextIssues )
		self.tIssuesSort.Bind( wx.EVT_TEXT, self.OnTextIssuesSort )
		self.tFlags.Bind( wx.EVT_TEXT, self.OnTextFlags )
		self.tFlagsSort.Bind( wx.EVT_TEXT, self.OnTextFlagsSort )
